...
async function loadReports() {
    ...
    list.innerHTML = isss.map(i => {
        ...
        return `<tr class="rep-row italic leading-snug leading-tight italic"><td class="py-5 px-2 align-top border-r border-slate-50 italic leading-tight leading-tight leading-tight leading-tight italic"><span class="block font-black text-slate-400 uppercase text-[7px] italic">${i.locations.floor}</span><span class="text-[10px] font-bold italic italic leading-tight leading-tight leading-tight leading-tight italic">${i.locations.name}</span><p class="text-[7px] font-bold text-slate-400 uppercase mt-2 italic italic leading-tight leading-tight">Zodpovedá: ${i.responsible_person || '--'}</p></td><td class="py-5 px-3 align-top italic leading-snug leading-tight leading-tight italic"><p class="font-bold text-slate-900 italic mb-3 leading-tight italic leading-tight leading-tight leading-tight italic">${i.title}</p><div class="space-y-4 italic leading-tight leading-tight italic leading-tight leading-tight italic">${logs.map(u => `<div class="flex justify-between items-start space-x-2 pb-1 italic leading-tight leading-tight leading-tight italic"><div class="flex-1 italic leading-tight leading-tight leading-tight italic"><div class="flex items-center space-x-2 mb-1 italic leading-tight leading-tight leading-tight leading-tight italic"><span class="font-black text-[7px] text-slate-400 uppercase italic leading-tight italic leading-tight leading-tight leading-tight italic">${fmtD(u.event_date)}</span><span class="text-[6px] font-black px-1 border rounded uppercase italic leading-tight italic leading-tight leading-tight ${u.status_to === 'Opravené' || u.status_to === 'Vybavené' ? 'text-green-600' : 'text-slate-400'}">${u.status_to}</span></div><p class="text-[9px] text-slate-700 italic leading-snug leading-tight leading-tight leading-tight leading-tight leading-tight leading-tight leading-tight italic leading-tight">${u.note || '--'}</p></div>${u.photo_url ? `<img src="${u.photo_url ? `
  <img 
    src="${u.photo_thumb_url || u.photo_url}" 
    class="report-thumb cursor-pointer" 
    loading="lazy" 
    decoding="async"
    onclick="window.open('${u.photo_url}')"
  >
` : ''}</div>`).join('')}</div></td><td class="py-5 px-1 align-top text-center italic leading-tight leading-tight italic leading-tight leading-tight leading-tight leading-tight leading-tight leading-tight leading-tight leading-tight leading-tight leading-tight italic leading-tight"><span class="text-[7px] font-black px-1.5 py-0.5 rounded uppercase italic leading-tight italic leading-tight leading-tight leading-tight leading-tight leading-tight leading-tight leading-tight italic ${i.status === 'Opravené' || i.status === 'Vybavené' ? 'text-green-600 bg-green-50' : 'text-red-500 bg-red-50'}">${i.status}</span></td></tr>`;
    }).join('');
}
